...
<nav class="navbar justify-content-between fixed-top">
    <a href="receptioniste.php" class="navbar-brand ms-2 customsizelogo">
...
<div class="content" style="overflow-x: hidden">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-success text-white fw-bold">
                        <h5 class="modal-title">Informations sur la reservation</h5>
    ...
    <div class="modal fade" id="addNewModalClient" tabindex="-1"
         aria-labelledby="addNewModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-success text-white fw-bold">
                    <h5 class="modal-title">Ajouter les informations du client</h5>
                    <button type="button" class="btn-close"
                            data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body text-success">
                    ...
                    <div class="modal-footer">
                        <a href="#" class="btn btn-success" data-bs-dismiss="modal" aria-label=""
    ...
    <div class="card text-center ms-3 me-2">
        <div class="card-header">
            ...
            <a href="#" class="btn btn-success btn-sm float-end text-white
                fw-bold" data-bs-toggle="modal" data-bs-target="#addNewModalClient">
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>1</td>
                        <td>1</td>
                        <td class="badge rounded-pill bg-success">Confirmé</td>
                        <td>
                            <a href="#">
                    ...
                    <tr>
                        ...
                        <td>2</td>
                        <td>2</td>
                        <td class="badge rounded-pill bg-primary">En attente</td>
                        <td>
                            <a href="#">
                                <i class="fas fa-edit text-primary"></i>
                            </a> /
                    ...
                    <tr>
                        ...
                        <td>3</td>
                        <td>3</td>
                        <td class="badge rounded-pill bg-danger">Annulée</td>
                        <td>
                            <a href="#">
                                <i class="fas fa-edit text-primary"></i>
                            </a> /
