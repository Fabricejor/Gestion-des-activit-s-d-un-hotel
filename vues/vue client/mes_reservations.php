    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse " id="navbarToggler">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 " style="margin-left: 15%">
                ...
                <li class="nav-item">
                    <a href="reservation.php" class="nav-link fw-bolder">Reserver chambres</a>
                </li>
                <li class="nav-item">
                    <a href="mes_reservations.php" class="nav-link active fw-bolder">Mes reservations</a>
                </li>
                <li class="nav-item">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-success text-white fw-bold">
                <h5 class="modal-title">Ajouter dans reservations</h5>
                <button type="button" class="btn-close"
                        data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body text-success">
                <form action="">
                    <div class="mb-3">
                        <label for="" class="form-label">Date entree</label>
                        <input type="date" class="form-control">
                    </div>

                    <div class="mb-3">
                        <label for="" class="form-label">Date Sortie</label>
                        <input type="date" class="form-control">
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Nombre d'adultes</label>
                        <input type="number" class="form-control">
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Nombre d'enfants</label>
                        <input type="number" class="form-control">
                    </div>
                    <div class="mb-3">
...
<!-- footer start -->
<footer class="bg-light text-center text-lg-start position-absolute bottom-0 w-100">
